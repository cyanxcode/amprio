            ...
            <div className="w-[90vw] lg:w-[31vw] lg:h-[36.5vw] flex justify-center flex-col px-5 ">
              ...
              <p className="mt-18 md:mt-2 text-lg text-gray-800">
                <h2 className="w-full text-left text-xl md:text-2xl font-prata text-[#023235]">
                  Amprio is not just a brand,
                </h2>
                it is a tribute to family, heritage, and dedication. The name
                itself is a fusion of AMIT and PREETI—a heartfelt acknowledgment
                of the unwavering support and hard work of the pillars behind
                this journey. With Amprio, we take a step further into the
                luxury lighting segment, introducing exclusive, handcrafted, and
                custom-made lighting solutions. Drawing inspiration from global
                designs while staying true to our Indian roots, Amprio
                seamlessly blends sophistication with architectural excellence.
              </p>
            </div>
          ...
          <div className="px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
            <div className="">
              <h2 className="w-full text-center text-3xl md:text-5xl font-prata text-[#023235] mb-4">
                The Journey of Mr. Amit Agarwal
              </h2>
              <div className="grid md:grid-cols-3 items-center">
                <blockquote className="text-center p-4 sm:px-7 col-span-2">
                  <p className="text-lg font-medium text-gray-800 md:text-xl md:leading-normal xl:leading-normal">
                    ...
                    of experience in the electrical industry, Mr. Agarwal has
              ...
              <div className="grid md:grid-cols-3 items-center">
                ...
                <blockquote className="text-center p-4 sm:px-7 col-span-2">
                  <p className="text-lg font-medium text-gray-800 md:text-xl md:leading-normal xl:text-xl xl:leading-normal">
                    ...
                    transitioned into advertising, collaborating with clients,
                    ...
                    —a brand that stands as a testament to perseverance,
                    innovation, and the transformative power of lighting. Her
                    journey proves that passion and persistence can illuminate
                    the path to success.
                  </p>
                </blockquote>
              </div>
